...
--[[
	...
	Stem(0, 35, 9, StemDepthMain, { 172, 122, 25, 255 }),
	Stem(2, 10, 5, StemDepthLight, { 254, 215, 0, 255 }),
	Stem(4, 15, 6, StemDepth, { 255, 166, 0, 255 }),
	-- Cloud(delay, extent, sparks, speed, outerSpeed, col, maxAge, scale, depth, scaleInEnd, scaleOutStart, fadeInEnd, fadeOutStart)
	Cloud(0, 22, 8, 1250, -50, { 57, 57, 55, 255 }, 70, 45, CloudDepth, 0.1, 1, 0.2, 0.8), -- main cloud
	Cloud(0, 10, 5, 950, 0, { 254, 168, 0, 255 }, 60, 40, CloudDepthMid, 0.1, 0.9, 0.2, 0.8), -- orange mid-ground fireball
	Cloud(0, 15, 7, 800, 35, { 57, 57, 55, 255 }, 70, 40, CloudDepthLower, 0.1, 1, 0.2, 0.8), -- main cloud (lower half)
	Cloud(0, 85, 7, -100, 150, { 57, 57, 55, 255 }, 65, 60, FrontCloudDepth0, 1, 1, 0.2, 0.8), -- ground level smoke cloud
--	Cloud(2, 30, 7, 45, 10, { 254, 232, 0, 128 }, 5, 10, FrontCloudDepth1, 0.9, 0.9, 0.5, 0.9, path .. "/effects/media/AdditiveLarge"), -- tertiary fireball
--	Cloud(0, 90, 6, 15, 20, { 254, 232, 0, 255 }, 3, 15, FrontCloudDepth2, 0.9, 0.9, 0.3, 0.9, path .. "/effects/media/AdditiveLarge"), -- secondary fireball
	Cloud(0, 5, 3, 950, -25, { 254, 254, 254, 245 }, 40, 30, FrontCloudDepth3, 0.3, 1, 0.3, 0.6, "effects/media/AdditiveLarge"), -- rising white fireball
	Cloud(0, 18, 6, 300, -25, { 254, 232, 0, 128 }, 60, 32.5, FrontCloudDepth1, 0.3, 0.5, 0.3, 0.7, "effects/media/AdditiveLarge"), -- rising fireball
--	Cloud(0, 10, 5, 8, -8, { 256, 226, 1, 255 }, 0.5, 6, FrontCloudDepth4, 0.9, 0.9, 0.1, 0.9, path .. "/effects/media/AdditiveLarge"), -- fast initial fireball
	Cloud(3, 30, 6, 700, -30, { 166, 166, 166, 255 }, 50, 20, FrontRingDepth, 0.1, 1, 0.5, 0.5), -- grey in-front ring
	Cloud(3, 30, 6, 480, 30, { 202, 202, 202, 255 }, 50, 20, BackRingDepth, 0.1, 1, 0.5, 0.5), -- lighter behind ring
	Streamers(1, 15),
	Streamers(1.2, 20),
	{
		Type = "sprite",
