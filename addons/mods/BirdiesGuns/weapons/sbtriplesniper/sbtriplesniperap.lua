		...
		States =
		{
			...
			Reload =
			{
				Frames =
				{
					...
					{ texture = "weapons/snipertower/Sniper-ReloadAnim03.png", duration = 0.05 },
				
					{ texture = "weapons/snipertower/Sniper-ReloadAnim05.png", duration = 0.05},
				
					{ texture = "weapons/snipertower/Sniper-ReloadAnim07.png", duration = 0.05 },
				
					{ texture = "weapons/snipertower/Sniper-ReloadAnim09.png", duration = 0.05 },
					{ texture = "weapons/snipertower/Sniper-ReloadAnim10.png", duration = 0.05 },
					{ texture = "weapons/snipertower/Sniper-ReloadAnim11.png", duration = 0.05 },
					
					{ texture = "weapons/snipertower/Sniper-ReloadAnim13.png", duration = 0.05 },
				
					{ texture = "weapons/snipertower/Sniper-ReloadAnim15.png", duration = 0.05 },
				
					{ texture = "weapons/snipertower/Sniper-ReloadAnim17.png", duration = 0.05 },
		
					{ texture = "weapons/snipertower/Sniper-ReloadAnim19.png", duration = 0.05 },
					mipmap = true,
					duration = 0.2,
				},
				NextState = "Normal",
